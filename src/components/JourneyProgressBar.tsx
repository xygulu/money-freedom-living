...
// 心印刻度（不做百分比——警惕会员积分/等级味）：四段各按该阶段实际点亮的灯比例
// 填充（走过≠整段实心），右侧显示当前阶段「已点亮 x/y 盏」。位置由左侧「阶段 n」
// 文案承担。没有评估过的阶段不造假进度。阶段 4 没有灯、没有终点线：整段淡色
// 常亮，只表示「活法中」，不渲染右值。纯静态填充，无动画（尊重 prefers-reduced-motion）。
